...
pub mod feature_collection_p_buffer {
    ...
    impl GeometryType {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                Self::EsriGeometryTypePoint => "esriGeometryTypePoint",
                Self::EsriGeometryTypeMultipoint => "esriGeometryTypeMultipoint",
                Self::EsriGeometryTypePolyline => "esriGeometryTypePolyline",
                Self::EsriGeometryTypePolygon => "esriGeometryTypePolygon",
                Self::EsriGeometryTypeMultipatch => "esriGeometryTypeMultipatch",
                Self::EsriGeometryTypeNone => "esriGeometryTypeNone",
            }
        }
    ...
    impl FieldType {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                Self::EsriFieldTypeSmallInteger => "esriFieldTypeSmallInteger",
                Self::EsriFieldTypeInteger => "esriFieldTypeInteger",
                Self::EsriFieldTypeSingle => "esriFieldTypeSingle",
                Self::EsriFieldTypeDouble => "esriFieldTypeDouble",
                Self::EsriFieldTypeString => "esriFieldTypeString",
                Self::EsriFieldTypeDate => "esriFieldTypeDate",
                Self::EsriFieldTypeOid => "esriFieldTypeOID",
                Self::EsriFieldTypeGeometry => "esriFieldTypeGeometry",
                Self::EsriFieldTypeBlob => "esriFieldTypeBlob",
                Self::EsriFieldTypeRaster => "esriFieldTypeRaster",
                Self::EsriFieldTypeGuid => "esriFieldTypeGUID",
                Self::EsriFieldTypeGlobalId => "esriFieldTypeGlobalID",
                Self::EsriFieldTypeXml => "esriFieldTypeXML",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
    ...
    impl SqlType {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                Self::BigInt => "sqlTypeBigInt",
                Self::Binary => "sqlTypeBinary",
                Self::Bit => "sqlTypeBit",
                Self::Char => "sqlTypeChar",
                Self::Date => "sqlTypeDate",
                Self::Decimal => "sqlTypeDecimal",
                Self::Double => "sqlTypeDouble",
                Self::Float => "sqlTypeFloat",
                Self::Geometry => "sqlTypeGeometry",
                Self::Guid => "sqlTypeGUID",
                Self::Integer => "sqlTypeInteger",
                Self::LongNVarchar => "sqlTypeLongNVarchar",
                Self::LongVarbinary => "sqlTypeLongVarbinary",
                Self::LongVarchar => "sqlTypeLongVarchar",
                Self::NChar => "sqlTypeNChar",
                Self::NVarchar => "sqlTypeNVarchar",
                Self::Other => "sqlTypeOther",
                Self::Real => "sqlTypeReal",
                Self::SmallInt => "sqlTypeSmallInt",
                Self::SqlXml => "sqlTypeSqlXml",
                Self::Time => "sqlTypeTime",
                Self::Timestamp => "sqlTypeTimestamp",
                Self::Timestamp2 => "sqlTypeTimestamp2",
                Self::TinyInt => "sqlTypeTinyInt",
                Self::Varbinary => "sqlTypeVarbinary",
                Self::Varchar => "sqlTypeVarchar",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
