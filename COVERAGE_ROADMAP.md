...
|-----------|-----------|----------|----------|-------------------|
| **Baseline** (Current) | 113 | 12 | 65% | 80% |
| **Bronze** (Phase 1) | 133 | 12 | 70% | 85% |
| **Silver** (Phase 2) | 163 | 16 | 75% | 92% |
| **Gold** (Phase 3) | 183 | 19 | 80% | 95% |
| **Platinum** (Full Coverage) | 183-200 | 19-20 | 80-85% | 95%+ |
